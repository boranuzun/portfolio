...
function showChatMode(prefillQuery?: string): void {
  ...
  if (prefillQuery) {
    sendMessage();
  } else if (getChatState().apiHistory.length === 0 && els.chatMessages && !els.chatMessages.hasChildNodes()) {
    addMessage("Hey! 👋 I know all about Boran's experience, projects, and skills. What would you like to know?", false);
  }
