...
- **AI-powered chatbot** — an interactive assistant that answers questions about my experience and projects, built with a Cloudflare Worker backend and the Gemini API
- **Dark / Light mode** — theme toggle with system preference detection and persistence
- **Smooth page transitions** — Astro View Transitions for SPA-like navigation without full reloads
- **Responsive design** — fully mobile-friendly layout
- **Blog & RSS** — markdown-powered blog with automatic RSS feed generation
